...
class Activiteit
{
    ...
    public function getPlaatsen(): ?int
    {
        return $this->plaatsen;
    }

    public function setPlaatsen(int $plaatsen): self
    {
    ...
    public function getInschrijvingen(): ?int
    {
        return $this->inschrijvingen;
    }

    public function setInschrijvingen(int $inschrijvingen): self
    {
